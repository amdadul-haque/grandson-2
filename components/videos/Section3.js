      ...
      <div className='container-wrapper text-gray-100 h-full flex flex-col gap-5 sm:gap-8 justify-center items-center'>
        ...
        <div className='grid md:grid-cols-2 gap-5 lg:gap-8'>
          ...
          <div className='text-box '>
            ...
            <p className='text-center'>Jako profesjonaliści od video marketingu, że każdy klient jest wyjątkowy, dlatego też każdy
              projekt traktujemy indywidualnie. Nasze podejście skupia się na głębokim zrozumieniu
