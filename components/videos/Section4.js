      ...
      <div className='container-wrapper text-gray-100 h-full flex flex-col gap-5 sm:gap-8 justify-center items-center'>
        <div className='flex flex-col md:flex-row gap-5 md:gap-8 md:justify-between'>
          <div className='text-box'>
            <p className='text-center'>Grandson Media to nie tylko agencja marketingowa - jesteśmy Twoim partnerem wosiąganiu
              ...
              rozwiązania w dziedzinie produkcji wideo, video content marketing oraz online video
              marketing, to jesteśmy tutaj, aby Ci pomóc i wspólnie stworzyć wyjątkowe projekty, które
