        ...
        <div className='flex flex-col lg:flex-row gap-5 md:gap-8 md:justify-between'>
          ...
          >
            ...
            <p className="!text-justify">
              Trener wystąpień publicznych <br /> i medialnych, komunikacji kryzysowej, wykładowca  Uniwersytetu Warszawskiego, dziennikarz Teleexpressu. Od ponad 30 lat w mediach , głównie w TVP gdzie był reporterem, wydawcą, prezenterem <br /> i Redaktorem Naczelnym PANORAMY w telewizyjnej „Dwójce” oraz  redakcji publicystyki. 
