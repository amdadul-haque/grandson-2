      ...
      <div className='container-wrapper text-gray-100 h-full flex flex-col gap-5 sm:gap-8 justify-center items-center'>
        <div className='flex flex-col md:flex-row gap-5 md:gap-8 md:justify-between'>
          ...
          >
            ...
            <p>
              Jeśli chcesz doskonalić swoje umiejętności komunikacyjne <br /> i osiągnąć sukces w świecie mediów, to warsztaty "Mistrzowie Mediów" są dla Ciebie. Skontaktuj się z nami już teraz i dołącz do naszej społeczności ambitnych i kreatywnych profesjonalistów!
              <br />
              <br />
