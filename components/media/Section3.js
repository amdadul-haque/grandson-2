    ...
    >
      <div className='container-wrapper text-gray-100 h-full flex flex-col gap-5 sm:gap-8 justify-center items-center'>
        ...
        >
          ...
          <p>
            Nasza oferta warsztatów skierowana jest nie tylko do indywidualnych uczestników, ale także do firm, które pragną przeszkolić swoich pracowników w  komunikacji medialnej. Warsztaty są dedykowane osobom pracującym w biznesie, chcącym doskonalić swoje umiejętności komunikacyjne w celu skuteczniejszego zarządzania firmą. Ponadto, kierujemy je również do przyszłych dziennikarzy, którzy pragną zdobyć praktyczną wiedzę i umiejętności niezbędne do rozpoczęcia kariery w mediach.
          </p>
        </motion.div>
      </div>
    </div>
