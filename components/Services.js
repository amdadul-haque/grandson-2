...
const Services = () => {
  return (
    <div className="flex items-center font-oswald justify-between w-full max-w-[1300px] mx-auto bg-hero gap-12 bg-center py-24">
      <div className="text-[#fff] pl-24 w-[60%]">
      ...
      <div className="grid grid-cols-3 gap-8 pr-24">
