        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 h-full w-full border-[2px] sm:border-[3px] md:border-[4px] lg:border-[5px] border-[#362F2F] hover:border-0 transition-all duration-300">
